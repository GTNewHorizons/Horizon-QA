...
!!! abstract "At a glance"
    ...
    - Each test runs in an isolated cell on a deterministic grid; CI/report presets default to a dedicated void world, and failures stay placed for in-game triage.
